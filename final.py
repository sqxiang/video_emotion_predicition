...
embbeding = pickle.load(open("PCA/train_images.pkl","rb"))
z = np.array([[0.0]*512])
...
test_embbeding = pickle.load(open("PCA/test_images.pkl","rb"))
...
model = Sequential()
#model.add(Masking(mask_value= 0.0,input_shape=(9, 500)))
model.add(LSTM(128,return_sequences=False,input_shape=(18,512)))

...
RGB_frames_train = '/home/sqxiang/workspace/liris/pipeline/data/train_finalframes30/'
RGB_frames_test = '/home/sqxiang/workspace/liris/pipeline/data/test_finalframes30/'
RGB_audio_train = '/home/sqxiang/workspace/liris/pipeline/data/train_finalaudioimages30/'
RGB_audio_test = '/home/sqxiang/workspace/liris/pipeline/data/test_finalaudioimages30/'
...
class videoRead(caffe.Layer):
	...
	def initialize(self):
		...
		self.video_list = '/home/sqxiang/workspace/liris/pipeline/videofile/train_videos_p.txt' 
	...
	def setup(self,bottom,top):
		...
		self.transformer = caffe.io.Transformer({'data': shape})
...
class videoReadTest_RGB(videoRead):
	...
	def initialize(self):
		...
		self.video_list = '/home/sqxiang/workspace/liris/pipeline/videofile/test_videos_p.txt' 
